...
def main() :
    ...
    ribo_file = '/home1/09369/umapaul/references/merged_mapq10.ribo'
    exps = ['16cell_Control', '32cell_Control']
    output_file = '/home1/09369/umapaul/output/allorf_TEST2.csv'
    uniqueorfs_file = '/home1/09369/umapaul/output/candidateORFsTEST2.csv'
    uorf_min = 33
    uorf_max = 300
    ...
    #reads_df.to_csv('/home1/09369/umapaul/output/allorf_outputALLREADS.csv', index = False)
    #readsFilt_df.to_csv('/home1/09369/umapaul/output/allorf_outputREADSFILT.csv', index = False)
    #full_df.to_csv('/home1/09369/umapaul/output/allorf_outputPERIODICITY.csv', index = False)
