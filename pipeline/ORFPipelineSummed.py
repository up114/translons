...
"""
Determine ORF candidates on aggregated coverage data
...
Outputs:
- output_file: output CSV file with ORF candidate coordinates
"""
def main() :
    # Set input and output variables
    appris_file = "appris_mouse_v2_selected.fa.gz"
    ribo_file = 'CA1_all_replicates.ribo'
    output_file = 'allorf_outputNEURAL.csv'
